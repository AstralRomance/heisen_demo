...
def test_reservation_create(product, target_vendor, create_reservation_config, create_reservation, drives_type):
    ...
    assert product.get_resource_status(reservation_config["server"]["model"])["is_reserved"]
